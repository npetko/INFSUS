...
const Nalog = ({ sendUgasiNalog }) => {
    ...
    //const nalog = JSON.parse(localStorage.getItem("mojiZahtjevi")).zahtjevi.find(item => item.brPutnogNaloga === brPutnogNaloga);
    ...
    //                 <p>Ime: {nalog.ime}</p>
    //                 <p>Prezime: {nalog.prezime}</p>
    //                 <p>Datum putovanja: {nalog.datumPutovanja}</p>
    //                 <p>Datum povratka: {nalog.datumPovratka}</p>
    //                 <p>Država putovanja: {nalog.državaPutovanja}</p>
    //                 <p>Mjesto putovanja: {nalog.mjesto}</p>
    //                 <p>Razlog putovanja: {nalog.razlog}</p>
    //                 <p>Akontacija: {nalog.akontacija}</p>
    //                 <p>Mjesto troška: {nalog.mjestoTroska}</p>
    ...
    //             </div>
    //
    //             <button className="optionsBtn" onClick={ugasiNalog}>Ugasi nalog</button>
    //         </div>
    //     </>
    //
    // )
